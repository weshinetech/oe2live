{application,nitrogen,
             [{description,"oe2"},
              ...
              {mod,{nitrogen_app,[]}},
              {env,[]},
              {modules,[cache,candidate_status,configs,db,dh_date,en,events,
                        exam,export,fields,helper,helper_access,helper_admin,
                        helper_api,helper_options,helper_ui,index,
                        instructions,layout,locale,login,
